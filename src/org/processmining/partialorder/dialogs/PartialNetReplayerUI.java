 ...
 * @author x.lu
 * 
 *         Copied from Arya's PNReplayerUI [Changes]
 * 
 *         17-01-2014 : instead of using PNAlgorithmStep, we used
 *         PartialNetAlgorithmStep to get replay algorithms that are partially
 *         ordered net aware. replaySteps[0] = new
 *         PartialNetAlgorithmStep(context, net, log, mapping);
 * 
 */
